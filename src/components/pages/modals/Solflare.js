                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="relative p-6 pb-0 flex-auto">
                            <div className="p-2 w-full text-start bg-white rounded-lg sm:p-2 dark:bg-gray-800">
                                <h5 className="mb-2 text-center text-3xl font-bold text-gray-900 dark:text-white">Solflare App</h5>
                                <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Solana is a highly functional open source project that implements a new, permissionless and high-speed layer-1 blockchain. <br />
