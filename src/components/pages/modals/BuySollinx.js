...
const BuySollinx = ({ onModal }) => {
    return (
        <>
            ...
            >
                <div className="relative w-auto my-3 mx-auto max-w-3xl bg-theme_dark rounded-lg" onClick={(e) => e.stopPropagation()}>
                    {/*content*/}
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="p-4 max-w-sm bg-white rounded-lg sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <p className="text-sm font-normal text-gray-500 dark:text-gray-400">Open one of these available wallet to buy sollinx.</p>
                            <ul className="my-4 space-y-3">
                                <li>
                                    <button className="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            ...
                            <div>
                                <button className="inline-flex items-center text-xs font-normal text-gray-500 hover:underline dark:text-gray-400">
