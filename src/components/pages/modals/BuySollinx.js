                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="p-4 max-w-sm bg-white rounded-lg sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <ul className="my-4 space-y-3">
                                ...
                                <li>
                                    <button className="flex items-center p-3 font-bold text-theme_modalfont bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            ...
                            <div>
                                <button className="inline-flex items-center text-xs font-normal text-theme_modalfont hover:underline dark:text-theme_modalfont">
                                    ...
                                    Why do I need to open my wallet?</button>
                            </div>
                        </div>
                        {/*footer*/}
                        <div className="flex items-center justify-end p-2 rounded-b">
                            <button
                                className="text-theme_modalfont background-transparent font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                type="button"
