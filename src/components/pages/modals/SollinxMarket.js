                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="relative p-6 pb-0 flex-auto">
                            <div className="p-2 w-full text-start bg-white rounded-lg sm:p-2 dark:bg-gray-800">
                                <h5 className="mb-2 text-center text-3xl font-bold text-theme_modalfont dark:text-white">DEX Lab</h5>
                                <p className="mb-5 text-base text-theme_modalfont sm:text-lg dark:text-theme_modalfont">Dexlab is a decentralized exchange where users can mint and list SPL tokens. 
