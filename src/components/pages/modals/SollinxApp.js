                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="relative p-6 pb-0 flex-auto">
                            <div className="p-2 w-full text-center bg-white rounded-lg sm:p-2 dark:bg-gray-800">
                                ...
                                <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Sollinx App is designed for mobile and android which boost your sollinx transaction. It can be easily set up and provide friendly-interface</p>
