                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="relative p-6 pb-0 flex-auto">
                            <div className="p-2 w-full text-center bg-white rounded-lg sm:p-2 dark:bg-gray-800">
                                <h5 className="mb-2 text-3xl font-bold text-theme_modalfont dark:text-white">Sollinx App</h5>
                                <p className="mb-5 text-base text-theme_modalfont sm:text-lg dark:text-gray-400">The Sollinx app is your interface to the Sollinx communities.  It is free.</p>
                                <div className="justify-center items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 text-theme_modalfont">
                        ...
                        {/*footer*/}
                        <div className="flex items-center justify-end p-2 rounded-b text-theme_modalfont">
                            <button
