        ...
        <Layout>
            <div className="h-full bg-theme_dark pb-5 text-theme_primary">
                ...
                <div className="m-auto w-10/12 md:w-10/12 mt-5 md:flex items-center bg-theme_paper rounded-lg md:flex-row hover:bg-theme_paper dark:border-theme_paper dark:bg-theme_paper dark:hover:bg-theme_paper">
                    <div className="flex flex-col justify-between p-0 leading-normal">
                        <h5 className="mb-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"></h5>
                        <p className="mb-3 font-normal md:text-xl lg:text-2xl text-gray-700 dark:text-gray-400"><img className="object-cover float-left w-16 h-auto rounded-t-lg md:h-auto md:w-16 md:rounded-none md:rounded-l-lg" loading="lazy" src="./assets/images/basketwClock.png" style={{ shapeOutside: "none", marginRight: "15px" }} alt="" />
                ...
                <div className="m-auto w-10/12 md:w-10/12 mt-5 md:flex items-center bg-theme_paper rounded-lg md:flex-row hover:bg-theme_paper dark:border-theme_paper dark:bg-theme_paper dark:hover:bg-theme_paper">
                    <div className="flex flex-col justify-between p-0 leading-normal">
                        <h5 className="mb-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"></h5>
                        <p className="mb-3 font-normal md:text-xl lg:text-2xl text-gray-700 dark:text-gray-400"><img className="object-cover float-left w-16 h-auto rounded-t-lg md:h-auto md:w-16 md:rounded-none md:rounded-l-lg" loading="lazy" src="./assets/images/privacy.png" style={{ shapeOutside: "none", marginRight: "15px" }} alt="" />
                ...
                <div className="justify-center w-full md:w-full mt-5 flex flex-col items-center bg-theme_dark  md:flex-col hover:bg-theme_dark dark:border-theme_dark text-white dark:hover:bg-theme_dark">
                    <div className="flex flex-col w-4/5 sm:w-4/5 md:w-6/12 bg-theme_dropdown1 rounded-3xl text-center p-0 leading-normal" style={{ cursor: "pointer", height:"120px", zIndex:"50", }} onClick={() => setShowDropdown(!showDropdown)}>
                        <img className="w-10 h-10 m-auto mt-2 mb-0 rounded-2xl" src="./assets/images/communitylogo.png" />
                        <h5 className="text-2xl font-bold" style={{ color: "white" }}>Sollinx Communities</h5>
                    </div>
                    {showDropdown ? (<div className="w-4/5 sm:w-4/5 md:w-6/12 mb-5 text-center">
                        ...
                        ><Link to="/finance">
                                <img className="w-14 h-12 float-left ml-1 mr-3 mt-4" src="./assets/images/finance_btn.png" /><p className="mt-6 text-xl" style={{textAlign:"start"}}>Finance</p>
                            </Link>
                        </button>
                        ...
                        >
                                <img className="w-16 h-14  float-left mr-2 mt-6" src="./assets/images/health_btn.png" /><p className="mt-10 text-xl" style={{textAlign:"start"}}>Health</p>
                        </button>
                        ...
                        >
                                <img className="w-16 h-14  float-left mr-2 mt-6" src="./assets/images/it_btn.png" /><p className="pt-6 text-xl" style={{textAlign:"start", display:"table-cell"}}>Information technology</p>
                        </button>
                        ...
                        >
                                <img className="w-16 h-14 float-left mr-2 mt-4" src="./assets/images/life_btn.png" /><p className="mt-8 text-xl" style={{textAlign:"start"}}>Life</p>
                        </button>
                    </div>) : null}
                </div>
